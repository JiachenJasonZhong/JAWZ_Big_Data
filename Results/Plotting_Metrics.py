            ...
            for model_name, data in data_dict.items():
                if metric in data.columns:
                    if 'timestep' in data.columns:
                        ...
                        plt.title(f"{model_name} ({title} - {clarifier}): {metric}")
                        plt.xlabel('Timestep')
...
lf_file_paths = {
    'LSTM_ASXGB': '/Users/ariasarch/JAWZ_Big_Data/LSTM_ASXGB_elliptic_LF_results.csv',
    'LSTM': '/Users/ariasarch/JAWZ_Big_Data/LSTM_Base_elliptic_LF_results.csv',
    'ASXGB': '/Users/ariasarch/JAWZ_Big_Data/ASXGB_elliptic_LF_results.csv',
    'ARF': '/Users/ariasarch/JAWZ_Big_Data/ARF_elliptic_LF_results.csv'
}

af_file_paths = {
    'LSTM_ASXGB': '/Users/ariasarch/JAWZ_Big_Data/LSTM_ASXGB_elliptic_AF_results.csv',
    'LSTM': '/Users/ariasarch/JAWZ_Big_Data/LSTM_Base_elliptic_AF_results.csv',
...
lf_norolling_file_paths = {
    'LSTM_ASXGB': '/Users/ariasarch/JAWZ_Big_Data/LSTM_ASXGB_elliptic_LF_results_norolling.csv',
    'LSTM': '/Users/ariasarch/JAWZ_Big_Data/LSTM_Base_elliptic_LF_results_norolling.csv',
    'ASXGB': '/Users/ariasarch/JAWZ_Big_Data/ASXGB_elliptic_LF_results_norolling.csv',
    'ARF': '/Users/ariasarch/JAWZ_Big_Data/ARF_elliptic_LF_results_norolling.csv'
}

af_norolling_file_paths = {
    'LSTM_ASXGB': '/Users/ariasarch/JAWZ_Big_Data/LSTM_ASXGB_elliptic_AF_results_norolling.csv',
    'LSTM': '/Users/ariasarch/JAWZ_Big_Data/LSTM_Base_elliptic_AF_results_norolling.csv',
    'ASXGB': '/Users/ariasarch/JAWZ_Big_Data/ASXGB_elliptic_AF_results_norolling.csv',
    'ARF': '/Users/ariasarch/JAWZ_Big_Data/ARF_elliptic_AF_results_norolling.csv'
}
